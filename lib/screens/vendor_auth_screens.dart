        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Benefits
              _buildBenefitItem('💰', 'Up to 20% commission'),
              _buildBenefitItem('📈', 'Track your sales in real-time'),
              _buildBenefitItem('🎯', 'Unique referral code'),
              _buildBenefitItem('🏆', 'Level up and earn more'),
              const SizedBox(height: 32),
